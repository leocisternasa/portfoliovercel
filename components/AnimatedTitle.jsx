...
const AnimatedTitle = () => {
  ...
  return (
    <div className="flex justify-center align-middle flex-wrap">
      ...
      <animated.div
        className="absolute sm:left-[40%] left-[50%] sm:top-[43.5%] top-[33%] translate-x-[-50%] text-3xl sm:text-5xl md:text-6xl text-gray-700 font-bold"
        style={fallingAnimation}
      >
        / Full-Stack
      </animated.div>
      <animated.div
        className="absolute sm:left-[40%] left-[-23%] top-[37.5%] sm:top-[43.5%] translate-x-[70%] text-3xl sm:text-5xl md:text-6xl text-gray-700 font-bold"
